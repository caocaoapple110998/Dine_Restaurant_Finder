...
public class Signin_Activity extends AppCompatActivity {
    ...
    public static final String TAG = Signin_Activity.class.getSimpleName();
    ...
    private void addControl() {
        edtUserName = (EditText) findViewById(R.id.editUsername_login);
        edtPassWord = (EditText) findViewById(R.id.editPassword_login);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObject.getInt("success") == 1) {
                                    ...
                                    Toast.makeText(Signin_Activity.this, message, Toast.LENGTH_SHORT).show();
